...
public class show extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			ResultSet rs=st.executeQuery("select t2.gatesid,name,contact,stime from gatesreg t1, "+eventid+" t2 where t1.gatesid=t2.gatesid and t2.etime='2007-01-01 00:00:00'");
			if(rs.next())
			{
				rs.previous();
				int i=1;
